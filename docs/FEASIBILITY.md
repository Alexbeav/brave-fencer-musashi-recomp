# Brave Fencer Musashi feasibility binding

## Identity

- Title and region: Brave Fencer Musashi, USA.
- Serial: SLUS-00726.
- Source executable path: `disc/SLUS_007.26`.
- Load address: `0x80010000`.
- Entry point: `0x80010000`.
- Source disc binding: `disc/Brave Fencer Musashi (USA).cue`.
...
The clean source commit is `e49de66bd12d1dd36cb84a97ddc1df00237952db`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 883 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `e49de66bd12d1dd36cb84a97ddc1df00237952db`.
- Portfolio `brave-fencer-musashi/BUILDINFO.json`.
- Portfolio `brave-fencer-musashi/RECEIPT.md`.
