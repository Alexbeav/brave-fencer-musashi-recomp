...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Brave Fencer Musashi",
    .project_root_env = "BRAVE_FENCER_MUSASHI_RECOMP_PROJECT_ROOT",
    .build_dir_env = "BRAVE_FENCER_MUSASHI_RECOMP_BUILD_DIR",
    .force_setup_env = "BRAVE_FENCER_MUSASHI_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_007.26_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Brave_Fencer_Musashi__Recompiled",
    .prepare_note =
